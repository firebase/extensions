...
export function delivered(ref: FirebaseFirestore.DocumentReference, info: any) {
  console.log(`Delivered message: ${ref.path} successfully.`, info);
}
