...
* Naming convention for resized images: How should the resized images be named? You can use the following variables
- {original-name} - the original name of the image.
- {size} - the size of the resized image (WIDTHxHEIGHT).
- {extension} - the extension of the resized image.

Learn more about [how this parameter works](https://firebase.google.com/products/extensions/storage-resize-images).
