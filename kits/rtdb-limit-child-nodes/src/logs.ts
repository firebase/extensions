...
export const childCount = (path: string, count: number) => {
  logger.log(`Node: '${path}' has: ${count} children`);
};
...
export const init = (config: ResolvedRtdbLimitConfig) => {
...
export const start = (config: ResolvedRtdbLimitConfig) => {
