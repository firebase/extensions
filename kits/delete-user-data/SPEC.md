...
The v2 path is the *blocking* `beforeUserDeleted` (Identity Platform), different
...
- [ ] Deleting a user removes data across Firestore/RTDB/Storage; auto-discovery
      + custom search behave as in the extension.
