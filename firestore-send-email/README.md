...
* SMTP connection URI: A URI representing an SMTP server that this extension can use to deliver email. Please note, port 25 is blocked by Google Cloud Platform, we recommend using port 587 for smtp connections. If you're using the smtps protocol, we recommend using port 465.
