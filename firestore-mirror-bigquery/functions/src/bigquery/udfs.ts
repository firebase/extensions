...
export const udfs: { (dataset: string): any }[] = [
  firestoreArrayFunction,
  firestoreBooleanFunction,
  firestoreNumberFunction,
  firestoreTimestampFunction,
  firestoreGeopointFunction,
];
...
export function firestoreTimestamp(datasetId:string, selector: string): string {
